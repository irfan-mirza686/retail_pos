...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="container-fluid">
			...
			<!-- SELECT2 EXAMPLE -->
			<form action="{{ url('/add-purchase') }}" method="post" id="purchaseForm">
				@csrf
				<div class="card card-default">
						...
						<div class="row"> 
							<!-- <div class="col-md-6"> -->
								<div class="form-group col-sm-12 col-md-3">
									...
									<input type="text" class="form-control" name="purchase_no" placeholder="Invoice  Number" id="purchase_no" value="{{ $purchase_no }}" readonly="" style="background-color: #D8FDBA">
								...
								<div class="form-group col-sm-12 col-md-3">
									...
									<input type="text" name="date" id="datepicker" class="form-control" value="" placeholder="DD-MM-YYYY">
									<font style="color: red;">
								...
								<div class="form-group col-sm-12 col-md-3">
									...
									<div class="input-group mb-4">
										<input type="text" class="form-control" placeholder="search supplier..." name="supplierName" id="supplierName">
					...
					<div class="card-body">
						...
						<table class="table-sm table-bordered" width="100%">
							...
							<tbody id="addRow" class="field_wrapper">
								<tr class="delete_add_more_item" id="delete_add_more_item">
									...
									<td>
										<input type="text" name="productName[]" class="form-control purchaseProdcutName" id="purchaseProdcutName" placeholder="search product...">
										<input type="hidden" name="product_id[]" id="productID" class="productID"> 
										<input type="hidden" name="stockQty[]" id="stockQty" class="stockQty">
										
									</td>
									<td>
										<input type="text" name="unit[]" id="unit" class="form-control unit">
									</td>
									<td>
									...
									<td>
										<input class="form-control text-right amount" name="item_amount[]">
									</td> 
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<input type="text" name="amount" value="0" id="total_amount" class="form-control form-control-sm text-right total_amount" readonly="" style="background-color: #D8FDBA">
						...
						<div class="form-group">
							<button type="submit" class="btn btn-success" id="storeButton" style="float: right;">Add Purchase</button>
						</div>
					</form>
				</div>
			</div><!-- /.container-fluid -->
