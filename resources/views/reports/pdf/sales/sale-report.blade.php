...
<body>
	...
	<center style=" width: 700px; margin: 0px auto;">
		<table cellspacing="0" cellpadding="0" border="0" style="font-family: Geneva, Verdana,  sans-serif; font-size:12px; color:#000000; line-height: 1rem;">
			<tr>
				<td style=" width: 100%; padding-top: 30px; text-align: center;"><strong>Sale -Report</strong></td>
			</tr><br>
			<tr>
				<td>
			...
			<tr>
				<td style="width: 100%;">
					<table class="table-suply" width="100%" cellspacing="0" cellpadding="0">
						<tr>
							<th colspan="12" align="center"><b>Sale Report Details</b></th>
						</tr>
                    ...
                    // echo"<pre>"; print_r($value['total_amount']); exit();
							...
							<tr>
								...
								<td colspan="3">{{$value['invoice_no']}}</td>
								<td colspan="3">{{$value['customers']['name']}}</td>
								<td colspan="3">{{number_format($value['amount'],2)}}</td>
							</tr>
							<?php
						}
						...
						<tr style="background-color: #FBCEB1; font-family: #POUND, sans-serif; font-weight: bold;">
							<td colspan="9" class="text-bold">Total</td>
							<td colspan="3">{{number_format($returnTotalAmount,2)}}</td>
						</tr>
			...
			<!-- 15nd Row -->
			<tr>
				<!-- <td colspan="12"><b>{{ Auth::user()->name }}, </b></td> -->
			</tr>
			<!-- 15nd Row -->
			<!-- 16nd Row -->
