...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="container-fluid">
			...
			<!-- SELECT2 EXAMPLE -->
			<form name="gateForm" id="gateForm" action="{{ url('/report-expense-pdf') }}"  method="post">
				@csrf
				...
				<div class="card card-dark">
					...
					<div class="card-body box-profile">
						...
						<div class="form-group row">
							<label for="inputSupplier" class="col-sm-2 col-form-label">Categoreis</label>
							<div class="col-sm-10 col-md-4">
								<select name="category_id" id="category_id" class="form-control select2" style="width: 100%;">
									<option selected="selected" disabled="true">-Select-</option>
									<option value="all" id="all_category">All</option>
									@foreach($expCateogry as $category)
