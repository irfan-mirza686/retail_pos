...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <!-- SELECT2 EXAMPLE -->
            <form name="groupForm" id="groupForm" action="{{ route('role.edit',$editGroup['id']) }}"  method="post">
                @csrf
                        ...
                        <div class="row"> 
                            <!-- <div class="col-md-6"> -->
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="Enter Group Name" id="name" value="{{ $editGroup->name }}" required="">
                                ...
                                @foreach($groupModule as $key => $data)
                                <option value="{{$key}}" @if(in_array($data['module_page'],$mergeArr)) selected="" @endif>&nbsp;{{$data['module_name']}}</option>
